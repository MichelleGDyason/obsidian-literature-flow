...
export default {
	...
	REMOVE_DUPLICATE_IDS_DESC:
		'Remove duplicated cards from the Literature Flow sidebar.<br>' +
	...
	SEARCH_FRONT_MATTER_LIMIT_DESC:
		'Number of entries shown in Literature Flow when <b>Get Using Frontmatter</b> is enabled.',
	...
	AUTO_DETECT_UPDATE_TO_CITEKEY_DESC:
		'Auto detect changes to the Library and update Literature Flow.<br>' +
	...
	DEBUG_MODE_DESC:
		...
		'Enabling this will also reset all Literature Flow reference data caches.<br>' +
	...
	SEE_DOCUMENTATION_DESC:
		"For more information, see the <a href='https://github.com/MichelleGDyason/obsidian-literature-flow'>Literature Flow documentation</a>.",
