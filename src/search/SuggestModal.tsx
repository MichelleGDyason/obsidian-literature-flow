...
export class ReferenceSuggestModal extends SuggestModal<Reference> {
    ...
    renderSuggestion(reference: Reference, el: HTMLElement) {
        ...
        el.createEl('div', { cls: 'lf-modal-paper-title', text: data.title });
        el.createEl('div', { cls: 'lf-modal-paper-authors', text: data.authors });
        el.createEl('div', { cls: 'lf-modal-paper-year', text: `${data.year}, ${data.journal}, ${data.volume}, ${data.pages}` });
    }
