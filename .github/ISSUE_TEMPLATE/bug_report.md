...
Step 1: Go to Literature Flow settings and turn on **Debug Mode**.
...
Step 4: Please include any relevant error messages that appear in the console in your report here. Literature Flow logs start with the prefix `LF: `.
